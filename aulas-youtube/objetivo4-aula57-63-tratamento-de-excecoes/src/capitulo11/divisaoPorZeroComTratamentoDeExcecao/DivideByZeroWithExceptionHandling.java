package capitulo11.divisaoPorZeroComTratamentoDeExcecao;
...
public class DivideByZeroWithExceptionHandling
{
    ...
    public static int quotient(int numerator, int denominator)
            throws ArithmeticException //lança uma excecao se dividido por zero
    {
    ...
    public static void main(String[] args)
    {
        ...
        do{
            ...
            try // lê dois números e calcula o quociente ÿ
            {
            ...
            catch (InputMismatchException inputMismatchException) //quando digito string
            {
            ...
            catch (ArithmeticException arithmeticException) //quando coloco zero
            {
